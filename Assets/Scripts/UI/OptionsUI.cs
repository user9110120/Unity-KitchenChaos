...
public class OptionsUI : MonoBehaviour
{
    ...
    [SerializeField] private TextMeshProUGUI interacrText;
    ...
    {
        soundEffectsText.text =  "Sound Effects: " + Mathf.Round(SoundManager.Instance.GetVolumn() * 10f);
        ...
        interacrText.text = GameInput.Instance.GetBindingText(GameInput.Binding.Interact);
